...
function wws_customize_register_slider( $wp_customize ) {
	...
	for ($i = 0; $i < $NumSliders; $i ++) {
		...
		/*** IMAGE ***/
		//Store the item
		$wp_customize->add_setting('wws_options[slider]['.$i.'][image]',
									array(
		...
		/*** TITLE ***/
		//Store the item
		$wp_customize->add_setting('wws_options[slider]['.$i.'][title]',
									array(
										'default'       => NULL, //'image.jpg',
										'capability'    => 'edit_theme_options',
										'type'          => 'theme_mod',
		...
		/*** CONTENT ***/
		//Store the item
		$wp_customize->add_setting('wws_options[slider]['.$i.'][content]',
									array(
										'default'       => NULL, //'image.jpg',
										'capability'    => 'edit_theme_options',
										'type'          => 'theme_mod',
		...
		/*** LINK ***/
		//Store the item
		$wp_customize->add_setting('wws_options[slider]['.$i.'][link]',
									array(
										'default'       => NULL,
										'capability'    => 'edit_theme_options',
										'type'          => 'theme_mod',
